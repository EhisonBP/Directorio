...
/**
 * Define la operación encargada de realizar la conexión a la base de datos.
 *
 * Los atributos generales de la base de datos son: <li>Host: 127.0.0.1</li>
 * <li>Puerto: 5432</li> <li>Driver: jdbc.postgresql</li> <li>Nombre: cnti</li>
 * <li>Usuario: postgres</li> <li>Contraseña: postgres</li>
 *
 *
 * Si el usuario desea ejecutar alguna sentencia en la base de datos debe
 * primero ejecutar {@link #iniciarConexion()}
 *
 * @author Ehison Perez
 *
 */
public class Conexion {
    ...
    private static String CONTRASEÑA = "22kscnti@GobLinea";
